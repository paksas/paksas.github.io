...
**[Using Unity to Help Solve Intelligence](https://arxiv.org/abs/2011.09294)** — Contributor on the team that adopted Unity 3D for AGI research; built the interfaces and protocols for exchanging data between agents and Unity environments. *(C#, Unity 3D, Python)*

**[DeepMind Control Suite](http://github.com/deepmind/dm_control)** — Owned the suite visualiser: implemented desktop and web (Colab) versions, open-sourced the project, and supported the user community. *(Python, MuJoCo, Colab)*
